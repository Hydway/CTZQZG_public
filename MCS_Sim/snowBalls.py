...
class snowBalls:
    ...
    def __init__(self,):
        ...
        self.showon = 0
        self.structure = None
        self.type = 'CLA_boost'       # 1.经典雪球：CLA; 2.经典雪球+买入期权：CLA_call; 3.OTM: OTM; 4.救生舱：LBT; 5.CLA_boost:经典雪球+指数增强产品
        self.freez = 2          # 封闭期
        # self.year = 2           # 雪球时长
        ...
        # 针对指数增强
        self.is_fix = 0 # 产品是否固定
        self.length_boost = 6 # 指增时长
    ...
    def loadData(self, filename=''):
        ...
        path = os.getcwd() + '\\' + 'HSI.HKEX.xlsx' + filename
    ...
    def backTrader(self, recent_year=0):
        ...
        for i in range(len(self.data)):            
            ...
            thsh = 0
            if self.recent_year:
                if i > len(self.data) - 21 * self.max_duration:
                    self.freez = 0
